  ...
  customElements.define(
    ...
    class CustomViewsCountComponent extends HTMLElement {
      constructor() {
        ...
        this.requestDebounce = this.debounce(
          this.sendViewsCountRequest.bind(this),
          100
        );
      }
      ...
      updateViewsCount() {
        if (CustomViewsCountComponent.viewsCount !== null) {
          const viewsCountElements =
            document.querySelectorAll("views-count") ||
            this.querySelector("views-count");
